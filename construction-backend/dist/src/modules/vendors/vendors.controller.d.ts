...
export declare class VendorsController {
    ...
    create(createVendorDto: CreateVendorDto, req: any): Promise<import("./models/vendor.model").Vendor>;
    ...
    assignToProject(assignVendorDto: AssignVendorDto, req: any): Promise<import("./models/project-vendor.model").ProjectVendor>;
    ...
    removeVendorFromProject(id: string, req: any): Promise<{
        message: string;
    }>;
}
