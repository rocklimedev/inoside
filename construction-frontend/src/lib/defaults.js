import { ThumbsUp, Upload, FileUp } from "lucide-react";
import {
  LayoutDashboard,
  FolderKanban,
  Building2,
...
export const navSections = [
...

  {
    title: "WORKFLOW",
    items: [
      { icon: ClipboardPen, label: "Brief", path: "/brief" },
      { icon: Presentation, label: "Pitch", path: "/pitches" },
      { icon: MapPinned, label: "Site Reki", path: "/site-reki" },
      { icon: ScrollText, label: "Scope of Work", path: "/scopes" },
      { icon: Timer, label: "Time & Cost", path: "/time-cost" },
      { icon: Calculator, label: "BOQ", path: "/boq" },
      { icon: HardHat, label: "Execution", path: "/execution" },
      { icon: Truck, label: "Vendors", path: "/vendors" },
      { icon: Boxes, label: "Inventory", path: "/inventory" },
      { icon: ShieldCheck, label: "Quality & Progress", path: "/quality" },
      { icon: KeyRound, label: "Handover", path: "/handover" },
    ],
  },

  {
    title: "DOCUMENTS",
    items: [
      { icon: DraftingCompass, label: "Drawings", path: "/drawings" },
      { icon: BadgeCheck, label: "Approvals", path: "/approvals" },
      { icon: FileBarChart, label: "Reports", path: "/reports" },
      { icon: GitBranch, label: "Revision Logs", path: "/revision-logs" },
    ],
  },

  {
    ...
    items: [
      ...
      { icon: UsersRound, label: "Team & Roles", path: "/team-roles" },
      {
        icon: Building,
        label: "Site Coordination",
        path: "/site-coordination",
      },
      { icon: NotebookPen, label: "Internal Notes", path: "/notes" },
    ],
  },
];
